<template>
  <div class="container" style="max-width: 560px">
    <vee-form
      ...
      @submit="submit"
    >
      <p class="card-header fw-semibold fs-2">THÊM HÀNG HÓA</p>
      ...
      <div class="card-body">
        ...
        <button class="btn btn-success" type="submit"><i class="fa-solid fa-check"></i> Tạo</button>
        <RouterLink to="/admin/products" class="btn">
