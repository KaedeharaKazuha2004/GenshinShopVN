  ...
  <div class="container py-4">
    ...
    >
      ...
      <div class="card-body">
        ...
        <button class="btn btn-success" type="submit"><i class="fa-solid fa-check"></i> Cập nhật</button>
        <RouterLink to="/admin/products" class="btn"><i class="fa-solid fa-arrow-rotate-left"></i> Quay lại </RouterLink>
      </div>
    </vee-form>
  </div>
</template>
