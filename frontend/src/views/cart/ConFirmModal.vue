    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title fw-semibold" id="confirmOrderLabel">XÁC NHẬN ĐƠN HÀNG</h5>
        </div>
        <div class="modal-body">
          <p>Vui lòng xác nhận đơn hàng của bạn một lần nữa trước khi tiến hành thanh toán:</p>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-danger" data-bs-dismiss="modal"><i class="fa-solid fa-xmark"></i> Hủy Bỏ</button>
          <button @click="placeOrder" type="button" class="btn btn-success"><i class="fa-solid fa-check"></i> Xác nhận</button>
        </div>
      </div>
    </div>
  </div>
